...
<%@ page import="handsome.is.joey.servlet.FormatJSONAndPutIntoBean" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <script type="text/javascript" src="assets/jqcloud-1.0.4.js"></script>
                ...
                <section class="content">
                    ...
                    <div class="row" style="margin-bottom:5px;">
                        ...
                        <div class="col-md-3" style="width: 100%; position: relative; padding-bottom: 66%;">
                            <img src="1.png" alt="" height="600px" width="900px">
